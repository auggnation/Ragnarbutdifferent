...
- **Hall of Records** — tracks longest uptime, most data used today / last 7 days / last 30 days, and all-time speed test top 10; accessible as a `🏆 RECORDS` dropdown in the web dashboard
...
2. Clone this repository to `/home/mild-viking/mild-viking`
3. Install Python dependencies from `requirements.txt`
4. Enable the SPI and I2C interfaces (required for e-paper)
...
If the Pi has no WiFi configured, it will broadcast a setup hotspot — connect to it and open `http://192.168.1.2:8000/settings` to configure your WiFi network.
...
<p align="center">
  <img src="resources/mild-viking-4.png" alt="E-paper display — speed test results" width="280">
</p>
...
```
traffic_monitor.py      — passive traffic monitoring and device tracking
...
data/
  ...
  device_stats.json     — Hall of Records and traffic history
```
